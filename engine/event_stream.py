...
class EventType(str, Enum):
    ...
    SUBAGENT_GRAPH_START = "SUBAGENT_GRAPH_START"
    SUBAGENT_WAVE_START = "SUBAGENT_WAVE_START"
    SUBAGENT_GRAPH_COMPLETE = "SUBAGENT_GRAPH_COMPLETE"
    LOOP_GOVERNOR_INIT = "LOOP_GOVERNOR_INIT"
    LOOP_GOVERNOR_TICK = "LOOP_GOVERNOR_TICK"
    LOOP_PROGRESS_SCORE = "LOOP_PROGRESS_SCORE"
    LOOP_CREDIT_APPLIED = "LOOP_CREDIT_APPLIED"
    LOOP_STALL_WARNING = "LOOP_STALL_WARNING"
    LOOP_BUDGET_DENY = "LOOP_BUDGET_DENY"
    BOOKKEEPING_WARNING = "BOOKKEEPING_WARNING"
    SHELL_POLICY_DIAGNOSTIC = "SHELL_POLICY_DIAGNOSTIC"
