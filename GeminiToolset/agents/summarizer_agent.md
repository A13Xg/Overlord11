...
**Purpose:** To create concise summaries of long-form text.

**Capabilities:**

*   **Abstractive Summarization:** Can generate a summary that captures the main ideas of a text in new words.
*   **Extractive Summarization:** Can identify and extract the most important sentences from a text to form a summary.
*   **Customizable Summary Length:** Can generate summaries of a desired length (e.g., short, medium, long).
